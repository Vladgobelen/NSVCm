import { createCloseButton } from "../dist/shared/DomHelpers.js";
...
class DiagnosticPanel {
    ...
    static open(client) {
        ...
        const diagHeader = this._modal.querySelector('.diagnostic-header');
        if (diagHeader) {
            diagHeader.appendChild(createCloseButton(() => {
