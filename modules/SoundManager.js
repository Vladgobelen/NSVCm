class SoundManager {
  ...
  static SoundFiles = {
    ...
    [SoundManager.SoundTypes.SOUND_CONNECTED]: 'user-join',
    [SoundManager.SoundTypes.SOUND_DISCONNECTED]: 'user-leave',
    [SoundManager.SoundTypes.SOUND_RECONNECTING]: 'mic-off'
  };
  ...
  static SoundGroups = [
    { name: '🔔 Звуки — Персональные', types: [SoundManager.SoundTypes.SOUND_MENTION, SoundManager.SoundTypes.SOUND_REPLY, SoundManager.SoundTypes.SOUND_DM] },
    { name: '📬 Уведомления — Персональные', types: [SoundManager.SoundTypes.NOTIFY_MENTION, SoundManager.SoundTypes.NOTIFY_REPLY, SoundManager.SoundTypes.NOTIFY_DM] },
    { name: '🔔 Звуки — В текущем чате', types: [SoundManager.SoundTypes.SOUND_CURRENT_MENTION, SoundManager.SoundTypes.SOUND_CURRENT_REPLY, SoundManager.SoundTypes.SOUND_CURRENT_NAME] },
    { name: '📬 Уведомления — В текущем чате', types: [SoundManager.SoundTypes.NOTIFY_CURRENT_MENTION, SoundManager.SoundTypes.NOTIFY_CURRENT_REPLY, SoundManager.SoundTypes.NOTIFY_CURRENT_NAME] },
    { name: '🔔 Звуки — Системные', types: [SoundManager.SoundTypes.SOUND_USER_JOIN, SoundManager.SoundTypes.SOUND_USER_LEAVE, SoundManager.SoundTypes.SOUND_MIC_ON, SoundManager.SoundTypes.SOUND_MIC_OFF, SoundManager.SoundTypes.SOUND_POPUP, SoundManager.SoundTypes.SOUND_CONNECTED, SoundManager.SoundTypes.SOUND_DISCONNECTED, SoundManager.SoundTypes.SOUND_RECONNECTING] }
  ];
  ...
  static getSoundTypes() { return Object.values(this.SoundTypes); }
  static getGroupedSoundTypes() { return this.SoundGroups; }
  static getLabel(settingType) { return this.SoundLabels[settingType] || settingType; }
