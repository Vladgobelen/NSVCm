class VolumeBoostManager {
    ...
    static isResuming: boolean = false;
    static gainNodes: Map<string, GainNode> = new Map();
    static sourceNodes: Map<string, MediaStreamAudioSourceNode> = new Map();
    static attachedElements: Map<string, HTMLAudioElement> = new Map();
    ...
    static async attachConsumer(consumer: any, userId: string, initialGain: number = 1.0): Promise<void> {
    ...
    static async attachToAudioElement(audioElement: HTMLAudioElement, userId: string, initialGain: number = 1.0): Promise<void> {
        ...
        try {
            ...
            this.gainNodes.set(userId, null as any);
        }
    }

    static setGain(userId: string, value: number): void {
    ...
    static getGain(userId: string): number | null {
        const gainNode = this.gainNodes.get(userId);
        if (gainNode) {
    ...
    static detach(userId: string): void {
    ...
    static async unlockAndroidAudio(): Promise<boolean> {
